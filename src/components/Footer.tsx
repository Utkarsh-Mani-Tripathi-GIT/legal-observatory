...
import { Landmark, ArrowRight, Mail, HelpCircle, Instagram } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4 md:col-span-1">
            ...
            <div className="flex space-x-3 text-slate-400 dark:text-slate-600">
              <a href="https://www.instagram.com/national.legal.observatory" target="_blank" rel="noopener noreferrer" className="hover:text-indigo-600 dark:hover:text-indigo-400 transition" aria-label="Instagram">
