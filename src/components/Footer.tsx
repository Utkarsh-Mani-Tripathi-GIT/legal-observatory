        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4 md:col-span-1">
            ...
            <div className="flex space-x-3 text-slate-400 dark:text-slate-600">
              ...
              <a href="https://github.com/Utkarsh-Mani-Tripathi-GIT/legal-observatory" target="_blank" rel="noopener noreferrer" className="relative group hover:text-indigo-600 dark:hover:text-indigo-400 transition" aria-label="GitHub">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
              ...
              <a href="mailto:bhoomija.k2810@gmail.com" className="relative group hover:text-indigo-600 dark:hover:text-indigo-400 transition" aria-label="Email">
