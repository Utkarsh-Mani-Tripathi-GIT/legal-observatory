...
const TargetCursor = ({
  targetSelector = '.cursor-target, a, button, .hover-target, .bk-btn, .bk-btn-fill, .shimmer-text',
  spinDuration = 2,
  hideDefaultCursor = true,
  hoverDuration = 0.2,
  parallaxOn = true,
  cursorColor = '#7d1919',
  cursorColorOnTarget = '#5c1212'
}: TargetCursorProps) => {
