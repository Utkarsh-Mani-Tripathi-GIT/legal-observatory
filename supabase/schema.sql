...
-- 7. Article Reminders Table
CREATE TABLE IF NOT EXISTS article_reminders (
...
ALTER TABLE article_reminders ENABLE ROW LEVEL SECURITY;
CREATE POLICY "Allow public insert to article_reminders" ON article_reminders FOR INSERT WITH CHECK (true);
